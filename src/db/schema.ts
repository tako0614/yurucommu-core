 ...
 * - schema/messaging.ts: activities, deliveryQueue, deliveryEndpointRecipients, deliveryResolutions, deliveryFanouts, deliveryCircuit, inbox, notificationArchived, dm*, dmCommunityReadStatus, mediaUploads, mediaBlobDeletionJobs
