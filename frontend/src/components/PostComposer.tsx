...
import { createResource, createSignal, For, Show } from "../lib/solid-compat";
      ...
      >
        ...
        >
          ...
          <form
            ...
            className="px-4 sm:px-6 py-4 sm:py-6 overflow-auto flex-1"
            onSubmit={submit}
          >
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="flex items-center rounded-full border border-gray-200 dark:border-gray-700 overflow-hidden text-sm">
                    <button
                      type="button"
                      className={`px-3 py-2 font-medium transition-colors ${audience() === "all"
                    ...
                    <button
                      type="button"
                      className={`px-3 py-2 font-medium transition-colors ${audience() === "community"
                        ? "bg-gray-900 text-white dark:bg-white dark:text-black"
                        : "bg-transparent text-gray-600 dark:text-gray-300"}`}
                ...
                <span className={`text-sm ${charCountClass()}`}>
                  {remainingChars()}
                </span>
              </div>
