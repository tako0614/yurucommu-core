...
function ToolButton(props: ToolButtonProps) {
  return (
    ...
    >
      <span class="text-white text-sm font-medium drop-shadow-md">{props.label}</span>
      <span class={`w-11 h-11 flex items-center justify-center rounded-full ${props.active ? 'bg-white/30' : 'bg-neutral-800/80'}`}>
        {props.icon}
      </span>
    </button>
  );
