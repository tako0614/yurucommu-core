...
export function StoryComposerSelectionToolbar(props: StoryComposerSelectionToolbarProps) {
  return (
    <Show when={props.selectedLayer && props.selectedLayer.type !== 'background'}>
