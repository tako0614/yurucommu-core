...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex w-72 bg-neutral-900 flex-col h-screen shrink-0">
      ...
      <div className="px-4 pb-6">
        <div className="mt-4 border-t border-neutral-900 pt-4">
          <div className="w-full text-left px-3 py-2 rounded-xl bg-neutral-900/40">
            <div className="text-xs text-neutral-500 mb-2">Account</div>
            <div className="text-sm font-medium truncate">{actor.name || actor.preferred_username}</div>
            <div className="text-xs text-neutral-500 truncate">@{actor.preferred_username}</div>
          </div>
        </div>
      </div>
    </aside>
