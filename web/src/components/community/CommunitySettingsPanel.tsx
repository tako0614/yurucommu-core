...
export function CommunitySettingsPanel(props: CommunitySettingsPanelProps) {
  return (
    <div class="p-4 space-y-6">
      ...
      {/* Icon Upload */}
      <div>
        <label class="block text-sm font-semibold text-neutral-300 mb-2">アイコン</label>
      ...
      {/* Display Name */}
      <div>
        <label class="block text-sm font-semibold text-neutral-300 mb-2">表示名</label>
        <input
          type="text"
          value={props.settingsForm.display_name || ''}
          onInput={(e) => props.onChangeSettings((prev) => ({ ...prev, display_name: e.currentTarget.value }))}
      ...
      {/* Summary */}
      <div>
        <label class="block text-sm font-semibold text-neutral-300 mb-2">説明</label>
        <textarea
          value={props.settingsForm.summary || ''}
          onInput={(e) => props.onChangeSettings((prev) => ({ ...prev, summary: e.currentTarget.value }))}
          rows={4}
      ...
      {/* Visibility */}
      <div>
        <label class="block text-sm font-semibold text-neutral-300 mb-2">公開範囲</label>
        <div class="space-y-2">
          <label class="flex items-center gap-3 p-3 bg-neutral-900 border border-neutral-700 rounded-lg cursor-pointer hover:border-neutral-600">
            <input
              ...
              onChange={() => props.onChangeSettings((prev) => ({ ...prev, visibility: 'public' }))}
              class="w-4 h-4 text-blue-500"
            />
            <div>
              <div class="text-white font-medium">公開</div>
              <div class="text-sm text-neutral-500">誰でもグループを見つけて閲覧できます</div>
            </div>
          </label>
          <label class="flex items-center gap-3 p-3 bg-neutral-900 border border-neutral-700 rounded-lg cursor-pointer hover:border-neutral-600">
            <input
              ...
              onChange={() => props.onChangeSettings((prev) => ({ ...prev, visibility: 'private' }))}
              class="w-4 h-4 text-blue-500"
            />
            <div>
              <div class="text-white font-medium">非公開</div>
              <div class="text-sm text-neutral-500">メンバーのみがグループの内容を閲覧できます</div>
            </div>
          </label>
        </div>
      </div>
      ...
      {/* Join Policy */}
      <div>
        <label class="block text-sm font-semibold text-neutral-300 mb-2">参加ポリシー</label>
        <div class="space-y-2">
          <label class="flex items-center gap-3 p-3 bg-neutral-900 border border-neutral-700 rounded-lg cursor-pointer hover:border-neutral-600">
            <input
              type="radio"
              ...
              onChange={() => props.onChangeSettings((prev) => ({ ...prev, join_policy: 'open' }))}
              class="w-4 h-4 text-blue-500"
            />
            <div>
          ...
          <label class="flex items-center gap-3 p-3 bg-neutral-900 border border-neutral-700 rounded-lg cursor-pointer hover:border-neutral-600">
            <input
              ...
              onChange={() => props.onChangeSettings((prev) => ({ ...prev, join_policy: 'approval' }))}
              class="w-4 h-4 text-blue-500"
            />
            <div>
              <div class="text-white font-medium">承認制</div>
              <div class="text-sm text-neutral-500">参加にはオーナーまたはモデレーターの承認が必要です</div>
            </div>
          </label>
          <label class="flex items-center gap-3 p-3 bg-neutral-900 border border-neutral-700 rounded-lg cursor-pointer hover:border-neutral-600">
            <input
              ...
              onChange={() => props.onChangeSettings((prev) => ({ ...prev, join_policy: 'invite' }))}
              class="w-4 h-4 text-blue-500"
            />
            <div>
              <div class="text-white font-medium">招待制</div>
              <div class="text-sm text-neutral-500">招待コードがないと参加できません</div>
            </div>
          </label>
        </div>
      </div>
      ...
      {/* Post Policy */}
      <div>
        <label class="block text-sm font-semibold text-neutral-300 mb-2">投稿ポリシー</label>
        <div class="space-y-2">
          <label class="flex items-center gap-3 p-3 bg-neutral-900 border border-neutral-700 rounded-lg cursor-pointer hover:border-neutral-600">
            <input
              type="radio"
              ...
              onChange={() => props.onChangeSettings((prev) => ({ ...prev, post_policy: 'anyone' }))}
              class="w-4 h-4 text-blue-500"
            />
            <div>
          ...
          <label class="flex items-center gap-3 p-3 bg-neutral-900 border border-neutral-700 rounded-lg cursor-pointer hover:border-neutral-600">
            <input
              ...
              onChange={() => props.onChangeSettings((prev) => ({ ...prev, post_policy: 'members' }))}
              class="w-4 h-4 text-blue-500"
            />
            <div>
              <div class="text-white font-medium">メンバーのみ</div>
              <div class="text-sm text-neutral-500">グループメンバーのみが投稿できます</div>
            </div>
          </label>
          <label class="flex items-center gap-3 p-3 bg-neutral-900 border border-neutral-700 rounded-lg cursor-pointer hover:border-neutral-600">
            <input
              ...
              onChange={() => props.onChangeSettings((prev) => ({ ...prev, post_policy: 'mods' }))}
              class="w-4 h-4 text-blue-500"
            />
            <div>
              <div class="text-white font-medium">モデレーター以上</div>
              <div class="text-sm text-neutral-500">モデレーターとオーナーのみが投稿できます</div>
            </div>
          </label>
          <label class="flex items-center gap-3 p-3 bg-neutral-900 border border-neutral-700 rounded-lg cursor-pointer hover:border-neutral-600">
            <input
              ...
              onChange={() => props.onChangeSettings((prev) => ({ ...prev, post_policy: 'owners' }))}
              class="w-4 h-4 text-blue-500"
            />
            <div>
              <div class="text-white font-medium">オーナーのみ</div>
              <div class="text-sm text-neutral-500">オーナーのみが投稿できます</div>
            </div>
          </label>
        </div>
      </div>
