        ...
        <div class="bg-neutral-900 rounded-2xl w-full max-w-md max-h-[80vh] flex flex-col">
          <div class="flex items-center justify-between px-4 py-3 border-b border-neutral-800">
            <div class="flex items-center gap-4">
              <button onClick={props.onClose} aria-label="Close" class="p-1 hover:bg-neutral-800 rounded-full transition-colors">
                <CloseIcon />
              </button>
              <h2 class="text-lg font-bold">
                {props.type === 'followers' ? props.t('profile.followers') : props.t('profile.following')}
              </h2>
            </div>
          </div>
                  ...
                  {(actor) => (
                    ...
                    >
                      ...
                      <div class="flex-1 min-w-0">
                        <div class="font-bold text-white truncate">{actor.name || actor.preferred_username}</div>
                        <div class="text-neutral-500 truncate">@{actor.username}</div>
                      </div>
                    </A>
                  )}
                </For>
