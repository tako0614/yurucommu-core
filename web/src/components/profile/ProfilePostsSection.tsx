    ...
    <>
      ...
      <div class="border-b border-neutral-900 flex">
        <button
          ...
          class={`flex-1 py-4 text-center font-bold transition-colors relative ${
            props.activeTab === 'posts' ? 'text-white' : 'text-neutral-500 hover:bg-neutral-900/50'
          }`}
        >
        ...
        <button
          ...
          class={`flex-1 py-4 text-center font-bold transition-colors relative ${
            props.activeTab === 'likes' ? 'text-white' : 'text-neutral-500 hover:bg-neutral-900/50'
          }`}
        >
      ...
      <Show when={props.activeTab === 'posts'}>
        <Show
          ...
          fallback={<div class="p-8 text-center text-neutral-500">{props.t('timeline.empty')}</div>}
        >
      ...
      {/* Likes Tab */}
      <Show when={props.activeTab === 'likes'}>
        <div class="p-8 text-center text-neutral-500">{props.t('profile.noLikes')}</div>
      </Show>
    </>
  );
}
    ...
    <div class="flex gap-3 px-4 py-3 border-b border-neutral-900 hover:bg-neutral-900/30 transition-colors">
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="flex items-center gap-6 mt-3">
          <button aria-label="Reply" class="flex items-center gap-2 text-neutral-500 hover:text-blue-500 transition-colors">
            <ReplyIcon />
          ...
          >
            ...
            <Show when={props.post.author.ap_id === props.actorApId && props.post.like_count > 0}>
