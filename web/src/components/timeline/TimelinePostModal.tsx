...
export function TimelinePostModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-start justify-center z-50 p-4 pt-12">
      <div className="bg-neutral-900 w-full max-w-lg rounded-2xl border border-neutral-800">
        {/* Modal Header */}
                  ...
                  {uploadedMedia.map((media, idx) => (
                    <div key={media.r2_key} className="relative">
                      ...
                      <button
                        ...
                        className="absolute -top-1 -right-1 bg-black/70 rounded-full p-0.5 hover:bg-neutral-900"
                      >
                        <CloseIcon />
                      </button>
                    </div>
