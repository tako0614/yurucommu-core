...
export function CommunityChatPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-neutral-900">
      {/* Header */}
      <header className="sticky top-0 bg-neutral-900/90 backdrop-blur-sm z-10 border-b border-neutral-900">
      ...
      {/* Input */}
      <div className="sticky bottom-0 bg-neutral-900 border-t border-neutral-900 px-4 py-3">
        <div className="flex items-end gap-2">
          <textarea
            ref={inputRef}
            value={inputValue}
